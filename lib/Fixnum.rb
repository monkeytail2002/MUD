class Fixnum
  ...
  #
  # Sets the strings for the damage performed.  First entry is for the attacker, second for the target
  #
  ...
  def spread
    ((self * 0.75).round..(self*1.25).round).to_a.simple
  end
